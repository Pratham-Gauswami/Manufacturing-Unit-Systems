...
static constexpr auto qt_meta_stringdata_ZN2UIE = QtMocHelpers::stringData(
    "UI",
    "startSimulation",
    "",
    "stopSimulation"
...
Q_CONSTINIT static const uint qt_meta_data_ZN2UIE[] = {
...
Q_CONSTINIT const QMetaObject UI::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN2UIE.offsetsAndSizes,
    qt_meta_data_ZN2UIE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN2UIE_t,
        // Q_OBJECT / Q_GADGET
...
void *UI::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN2UIE.stringdata0))
